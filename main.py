...
# reg = r"(\d{2})/(\d{2})/(\d{4})" # тут в фигурных даем сколько хотим цифр
# print(re.sub(reg, r"\2.\1.\3", s)) #делаем поиск и замену с помощью номера круглой скобки,меняем их местами и ставим .
...
# f = open(r"/Users/memetmemetov/Desktop/Python522/test1.txt")
# print(f)
# print(*f)
...
#
#
# print(Change.inc(3, 5, 7, 9))
# print(Change.dec(123, 4, 56, 76, 23))
# print(Change.denc(3, 5, 7, 9))
# print(Change.incd(5))
...
# date = Date.from_string("24.09.2003")
# print(date.string_to_db())
...
#         self.verifity_old(old)
#         self.werify_weight(weight)
#         self.werify_ps(ps)
#
#         self.fio = fio
#         self.old = old
...
#         letter = "".join(re.findall(r"[a-z-а-я-]", fio, flags=re.IGNORECASE))
#         for s in f:
...
#     @weight.setter
#     def weight(self, w):
#         self.werify_weight(w)
#         self.__weight = w
#
#
# p1 = UserData("Волков Виктор Николаевич", 34, "1231 234622", 80.8)
# p1.fio = "memetov emil memetovich"
# p1.old = 23
# p1.password = "3434 123456"
# print(p1.__dict__)
...
#         self._color = color
#         self._width = width
#         print("Инициализатоор класса Prop")
#
#
# class Line(Prop):
#
#     def __init__(self, *args):
#         print("Переопределенный инициализаор Line")
#         super().__init__(*args)
#
#     def draw_line(self):
#         print(f"Это рисование линии: {self._sp}, {self._ep}, {self._color}, {self._width}")
#
#
# class Rect(Prop):
#
...
# shape1.show_rect()
# print()
# chape2 = RectBorder(600, 300, "1px", "solid", "blue")
# chape2.show_rect()
...
# figs.append(Line(Point(10, 20), Point(20, 20)))
